...
def ngram(analyzer: str, train_texts: List, train_labels: List, test_texts: List, test_labels: List, gram_range: List,
          ...
          dual: bool,
        #   dual: False, 
          log_prefix: str, save_path: str = None, project: str = '', 
...
if __name__ == '__main__':
    ...
    parser.add_argument('--project', type=str, default='AA_region',
                        help='the mlflow experiment name')
    parser.add_argument('--train_dataset', type=str,
                        # default='/mnt/sdb/yujia/Valla/valla/dsets/AA_cls_train.csv')
                        default='/mnt/sdb/yujia/Valla/processed/CCAT50_train.csv')
    parser.add_argument('--val_dataset', type=str, default='')
    parser.add_argument('--test_dataset', type=str,
                        # default='/mnt/sdb/yujia/Valla/valla/dsets/AA_cls_test.csv')
                        default='/mnt/sdb/yujia/Valla/processed/CCAT50_AA_test.csv')
    parser.add_argument('--save_path', type=str, default='/mnt/sdb/yujia/Valla')
    ...
    parser.add_argument('--logistic_regression', action='store_true', default=False)
